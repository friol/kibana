...
import { getTasks } from '../../../../lib/elasticsearch/tasks';
import { getShardStats } from '../../../../lib/elasticsearch/shards';
import { handleError } from '../../../../lib/errors/handle_error';
import { prefixIndexPattern } from '../../../../lib/ccs_utils';
import { INDEX_PATTERN_ELASTICSEARCH } from '../../../../../common/constants';

export function esTasksRoute(server) {
  server.route({
    method: 'POST',
    path: '/api/monitoring/v1/clusters/{clusterUuid}/elasticsearch/tasks',
    config: {
      validate: {
        params: Joi.object({
    ...
    async handler(req) {
      ...
      try {
        ...
        const tasks = await getTasks(req, esIndexPattern, shardStats);
